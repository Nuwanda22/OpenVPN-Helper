	...
	class Program
	{
		static void Main(string[] args)
		{
			try
			{
				...
				//OpenVpn ovpn = (OpenVpn)bf.Deserialize(File.OpenRead(@"C:\Users\Nuwanda\Desktop\data.bin"));
				OpenVpn ovpn = (OpenVpn)bf.Deserialize(File.OpenRead(@"C:\Program Files\OpenVPN Helper\data.bin"));
